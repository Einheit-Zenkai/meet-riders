...
function StartPartyPage() {
    ...
    const [expiresIn, setExpiresIn] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(60); // in minutes
    ...
    const handleStartParty = async ()=>{
        ...
        // Required fields: start_time, end_time, seats_available
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("parties").insert([
            {
                ...
                is_active: true,
                ride_options: selectedRides.length > 0 ? selectedRides.join(",") : null
            }
        ]);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba7adf53._.js.map