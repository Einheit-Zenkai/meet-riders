...
"[project]/src/stores/partyStore.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const usePartyStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set)=>({
        parties: [],
        addParty: (partyData)=>{
...
const __TURBOPACK__default__export__ = usePartyStore;
}),
"[project]/src/components/store-initializer.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function StoreInitializer() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$authStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getState().init();
        const cleanupParties = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$partyStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getState().startCleanup();
        return ()=>{
            cleanupParties();
        };
    }, []);
...
"[project]/src/components/NotificationDropdown.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module './NotificationDropdown.css'");
...
function NotificationDropdown() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchNotifications = async ()=>{
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("party_requests").select("id, user_id, user_name, user_profile").eq("status", "Pending");
            if (error) {
        ...
        const subscription = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].channel('party_requests').on('postgres_changes', {
            event: 'INSERT',
            schema: 'public',
        ...
        return ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].removeChannel(subscription);
        };
    }, []);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3038b330._.js.map