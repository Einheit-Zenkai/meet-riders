    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotificationDropdown.useEffect": ()=>{
            ...
            const fetchNotifications = {
                "NotificationDropdown.useEffect.fetchNotifications": async ()=>{
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("party_requests").select("id, user_id, user_name, user_profile").eq("status", "Pending");
                    if (error) {
            ...
            }["NotificationDropdown.useEffect.fetchNotifications"];
            fetchNotifications();
            // Subscribe to real-time updates
            const subscription = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('party_requests').on('postgres_changes', {
                event: 'INSERT',
                schema: 'public',
                table: 'party_requests'
            }, {
                "NotificationDropdown.useEffect.subscription": (payload)=>{
                    setNotifications({
                        "NotificationDropdown.useEffect.subscription": (prev)=>[
                                payload.new,
                                ...prev
                            ]
                    }["NotificationDropdown.useEffect.subscription"]);
                }
            }["NotificationDropdown.useEffect.subscription"]).subscribe();
            return ({
                "NotificationDropdown.useEffect": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].removeChannel(subscription);
                }
            })["NotificationDropdown.useEffect"];
        }
    }["NotificationDropdown.useEffect"], []);
...
_s(NotificationDropdown, "WRTLdl6PUTfEhcxb3ij0hFbIfNM=");
...
//# sourceMappingURL=src_66c4a83b._.js.map