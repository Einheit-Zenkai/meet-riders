...
function NotificationsDropdown() {
    ...
    const addNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$notificationsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationsStore"])({
        "NotificationsDropdown.useNotificationsStore[addNotification]": (s)=>s.add
    }["NotificationsDropdown.useNotificationsStore[addNotification]"]);
    const removeNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$notificationsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationsStore"])({
        "NotificationsDropdown.useNotificationsStore[removeNotification]": (s)=>s.remove
    }["NotificationsDropdown.useNotificationsStore[removeNotification]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotificationsDropdown.useEffect": ()=>{
            let isMounted = true;
            ({
                "NotificationsDropdown.useEffect": async ()=>{
                    const { data: auth } = await supabase.auth.getUser();
                    const currentUser = auth === null || auth === void 0 ? void 0 : auth.user;
                    if (!currentUser || !isMounted) return;
                    // Helper: fetch display name for a user
                    const getDisplayName = {
                        "NotificationsDropdown.useEffect.getDisplayName": async (userId)=>{
                            const { data: profile } = await supabase.from('profiles').select('full_name, nickname').eq('id', userId).single();
                            return (profile === null || profile === void 0 ? void 0 : profile.nickname) || (profile === null || profile === void 0 ? void 0 : profile.full_name) || 'Someone';
                        }
                    }["NotificationsDropdown.useEffect.getDisplayName"];
                    // Helper: fetch party host id and short name/destination
                    const getPartyInfo = {
                        "NotificationsDropdown.useEffect.getPartyInfo": async (partyId)=>{
                            const { data: party } = await supabase.from('parties').select('id, host_id, drop_off').eq('id', partyId).single();
                            return party;
                        }
                    }["NotificationsDropdown.useEffect.getPartyInfo"];
                    ...
                    const channel = supabase.channel('party-requests-notifs').on('postgres_changes', {
                        ...
                        "NotificationsDropdown.useEffect.channel": async (payload)=>{
                            ...
                            const notifId = "join-request:".concat(rec.id || rec.request_id || rec.user_id + ':' + rec.party_id);
                            addNotification({
                                id: notifId,
                                message: "".concat(requesterName, " is trying to join your party"),
                                timestamp: new Date(),
                                read: false,
                                type: 'join_request',
                                meta: {
                    ...
                    }["NotificationsDropdown.useEffect.channel"]).on('postgres_changes', {
                        event: 'UPDATE',
                        schema: 'public',
                        table: 'party_requests'
                    }, {
                        "NotificationsDropdown.useEffect.channel": async (payload)=>{
                            ...
                            if (rec.status === 'accepted') {
                                addNotification({
                                    id: "join-accepted:".concat(rec.id || rec.request_id),
                                    message: "You have joined ".concat(hostName, "'s party"),
                                    timestamp: new Date(),
                                    read: false,
                                    type: 'success',
                                    href: '/current-party',
                                ...
                                addNotification({
                                    id: "join-declined:".concat(rec.id || rec.request_id),
                                    message: "".concat(hostName, " declined your join request"),
                                    timestamp: new Date(),
                                    read: false,
                                    type: 'error',
                                    meta: {
                ...
                children: [
                    ...
                    notifications.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: notifications.map((n)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-full text-left p-3 ".concat(!n.read ? 'bg-accent/20' : ''),
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            n.type !== 'join_request' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    n.type === 'join_request' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(NotificationsDropdown, "gm+wbmlhtjkCMVWqbrXDj29hsfQ=", false, function() {
    return [
...
const useDashboardDataStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        refreshParties: async ()=>{
            ...
            try {
                ...
                if (error) {
                    var _this;
                    console.error("Error fetching parties:", ((_this = error) === null || _this === void 0 ? void 0 : _this.message) || error);
                    set({
                        parties: [],
                        partiesLoading: false
                    });
                ...
                if (profilesError) {
                    var _this1;
                    console.error("Error fetching profiles:", ((_this1 = profilesError) === null || _this1 === void 0 ? void 0 : _this1.message) || profilesError);
                }
                ...
                try {
                    var _this2;
                    console.error("Failed to fetch parties:", ((_this2 = error) === null || _this2 === void 0 ? void 0 : _this2.message) || JSON.stringify(error));
                } catch (e) {
...
"[project]/src/lib/party.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getPartyOccupancy = (party, membersOverride)=>{
    const effectiveMembers = getJoinedMembers(membersOverride !== null && membersOverride !== void 0 ? membersOverride : party.members);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$party$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/party.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function PartyMembersDialog(param) {
    ...
    const visibleMembers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PartyMembersDialog.useMemo[visibleMembers]": ()=>members.filter({
                "PartyMembersDialog.useMemo[visibleMembers]": (member)=>member.user_id !== party.host_id
            }["PartyMembersDialog.useMemo[visibleMembers]"])
    }["PartyMembersDialog.useMemo[visibleMembers]"], [
        members,
        party.host_id
    ]);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogTitle"], {
                            ...
                            children: [
                                ...
                                "Party Members (",
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$party$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPartyOccupancy"])(party, members),
                                "/",
                                party.party_size,
                                ")"
                            ]
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 160,
                                columnNumber: 13
                            }, this) : visibleMembers.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-center py-6 text-muted-foreground",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$users$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Users$3e$__["Users"], {
                                        className: "w-8 h-8 mx-auto mb-2 opacity-50"
...
_s(PartyMembersDialog, "7WL583UKxUHgOJ9C4qRZfxTFvLU=", false, function() {
    return [
...
function DashboardPartyCard(param) {
    ...
    const supabaseClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPartyCard.useMemo[supabaseClient]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])()
    }["DashboardPartyCard.useMemo[supabaseClient]"], []);
    ...
    const handleJoinParty = async ()=>{
        ...
        try {
            ...
            if (existing && existing.length && existing[0].status === 'pending') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info('Join request already pending');
                return;
            }
            ...
            if (error) {
                var _code_toString;
                const anyErr = error;
                const code = (anyErr === null || anyErr === void 0 ? void 0 : anyErr.code) || (anyErr === null || anyErr === void 0 ? void 0 : anyErr.details) || '';
                if ((code === null || code === void 0 ? void 0 : (_code_toString = code.toString) === null || _code_toString === void 0 ? void 0 : _code_toString.call(code).includes('23505')) || ((anyErr === null || anyErr === void 0 ? void 0 : anyErr.message) || '').toLowerCase().includes('duplicate')) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info('Join request already pending');
                    return;
                }
                const errMsg = (anyErr === null || anyErr === void 0 ? void 0 : anyErr.message) || (anyErr === null || anyErr === void 0 ? void 0 : anyErr.hint) || (anyErr === null || anyErr === void 0 ? void 0 : anyErr.details) || 'Unknown error';
                console.error('Error creating party request:', errMsg, anyErr);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to send join request');
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Request sent to host');
            }
        } catch (error) {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    children: [
                                                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$party$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPartyOccupancy"])(party),
                                                                        "/",
                                                                        party.party_size
                                                                    ]
                                                                }, void 0, true, {
                                                ...
                                                children: isHost ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                    ...
                                                    children: [
                                                        party.user_is_member ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                            ...
                                                            disabled: isExpired || isJoining || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$party$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPartyOccupancy"])(party) >= party.party_size,
                                                            className: "h-8 text-xs",
                                                            variant: isExpired || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$party$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPartyOccupancy"])(party) >= party.party_size ? "outline" : "default",
                                                            children: isJoining ? 'Joining...' : isExpired ? 'Expired' : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$party$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPartyOccupancy"])(party) >= party.party_size ? 'Full' : 'Join Party'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/(main)/dashboard/components/DashboardPartyCard.tsx",
                                                            lineNumber: 521,
                                                            columnNumber: 45
...
_s(DashboardPartyCard, "iHxYpld9a7Xu02F0ico0km6TwGg=", false, function() {
    return [
...
function useDashboard() {
    ...
    const parties = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$dashboardDataStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "useDashboard.useDashboardDataStore[parties]": (state)=>state.parties
    }["useDashboard.useDashboardDataStore[parties]"]);
    const [hasActiveParty, setHasActiveParty] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDashboard.useEffect": ()=>{
            ...
            const active = parties.some({
                "useDashboard.useEffect.active": (party)=>{
...
_s(useDashboard, "lJVayhHTQBVfESft0BZdADtB5po=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$dashboardDataStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
...
class SoiMemberService {
    async join(soiId) {
        try {
            ...
            if ((existing === null || existing === void 0 ? void 0 : existing.status) === 'joined') {
            // Already joined; nothing to change
                ...
                if (updateError || !updated) {
                    return {
                        success: false,
                        error: (updateError === null || updateError === void 0 ? void 0 : updateError.message) || 'Failed to re-join SOI'
                    };
                }
                activeRow = updated;
            } else {
                ...
                if (insertError || !inserted) {
                    const message = (insertError === null || insertError === void 0 ? void 0 : insertError.message) || 'Failed to join';
...
function SoiList() {
    ...
    const fetchSOIs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SoiList.useCallback[fetchSOIs]": async (options)=>{
            var _options_silent;
            const silent = (_options_silent = options === null || options === void 0 ? void 0 : options.silent) !== null && _options_silent !== void 0 ? _options_silent : false;
            ...
            try {
                ...
                const list = (data || []).map({
                    "SoiList.useCallback[fetchSOIs].list": (r)=>({
                            id: r.id,
                ...
                }["SoiList.useCallback[fetchSOIs].list"]);
                const soiIds = list.map({
                    "SoiList.useCallback[fetchSOIs].soiIds": (item)=>String(item.id)
                }["SoiList.useCallback[fetchSOIs].soiIds"]);
                ...
                if (soiIds.length) {
                    ...
                    if (!memberError && memberRows) {
                        for (const row of memberRows){
                            ...
                            var _membersBySoi_get;
                            const bucket = (_membersBySoi_get = membersBySoi.get(soiId)) !== null && _membersBySoi_get !== void 0 ? _membersBySoi_get : [];
                            bucket.push({
                                user_id: row.user_id,
                                status: row.status
                            });
                ...
                const decorated = list.map({
                    "SoiList.useCallback[fetchSOIs].decorated": (item)=>{
                        const viewerIsHost = Boolean(userId && userId === item.host_id);
                        var _membersBySoi_get;
                        const partyMembers = (_membersBySoi_get = membersBySoi.get(String(item.id))) !== null && _membersBySoi_get !== void 0 ? _membersBySoi_get : [];
                        const hostAlreadyMember = partyMembers.some({
                            "SoiList.useCallback[fetchSOIs].decorated.hostAlreadyMember": (member)=>member.user_id === item.host_id
                        }["SoiList.useCallback[fetchSOIs].decorated.hostAlreadyMember"]);
                ...
                }["SoiList.useCallback[fetchSOIs].decorated"]);
                setItems(decorated);
            } finally{
                if (!silent) setLoading(false);
            }
        }
    }["SoiList.useCallback[fetchSOIs]"], [
        supabase,
        userId
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleJoin = async (id)=>{
        ...
        if (current.user_is_member || userId && current.host_id === userId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("You're already in this SOI.");
            return;
        }
        if ((current.current_member_count || 0) >= current.party_size) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("This SOI is full.");
            return;
        }
        ...
        if (!res.success) {
            if (res.error && res.error.toLowerCase().includes("already")) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info(res.error);
                const updated = [
                    ...items
                ];
                updated[idx] = {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res.error || "Failed to join");
            }
            return;
        }
    ...
    const handleLeave = async (id)=>{
        ...
        if (!current.user_is_member) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("You're not part of this SOI.");
            return;
        }
        ...
        if (!res.success) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res.error || "Failed to leave");
            return;
        }
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: isHost ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            children: !isMember ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(SoiList, "v/EGYw6Br91S3+dCAN7BR89QBFw=");
_c = SoiList;
var _c;
...
"[project]/src/app/(main)/dashboard/components/CurrentPartySection.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CurrentPartySection() {
    _s();
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "CurrentPartySection.useAuthStore[user]": (s)=>s.user
    }["CurrentPartySection.useAuthStore[user]"]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [busyIds, setBusyIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const addNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$notificationsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationsStore"])({
        "CurrentPartySection.useNotificationsStore[addNotification]": (s)=>s.add
    }["CurrentPartySection.useNotificationsStore[addNotification]"]);
    const hasNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$notificationsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationsStore"])({
        "CurrentPartySection.useNotificationsStore[hasNotification]": (s)=>s.has
    }["CurrentPartySection.useNotificationsStore[hasNotification]"]);
    const removeNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$notificationsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationsStore"])({
        "CurrentPartySection.useNotificationsStore[removeNotification]": (s)=>s.remove
    }["CurrentPartySection.useNotificationsStore[removeNotification]"]);
    const pushNotificationsForRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CurrentPartySection.useCallback[pushNotificationsForRequests]": (items)=>{
            items.forEach({
                "CurrentPartySection.useCallback[pushNotificationsForRequests]": (request)=>{
                    var _request_userProfile, _request_userProfile1, _request_party;
                    const notifId = "join-request:".concat(request.id);
                    if (hasNotification(notifId)) return;
                    const riderName = ((_request_userProfile = request.userProfile) === null || _request_userProfile === void 0 ? void 0 : _request_userProfile.nickname) || ((_request_userProfile1 = request.userProfile) === null || _request_userProfile1 === void 0 ? void 0 : _request_userProfile1.full_name) || "A rider";
                    const destination = ((_request_party = request.party) === null || _request_party === void 0 ? void 0 : _request_party.drop_off) ? " to ".concat(request.party.drop_off) : "";
                    addNotification({
                        id: notifId,
                        message: "".concat(riderName, " wants to join your party").concat(destination),
            ...
            }["CurrentPartySection.useCallback[pushNotificationsForRequests]"]);
        }
    }["CurrentPartySection.useCallback[pushNotificationsForRequests]"], [
        addNotification,
        hasNotification
    ...
    const loadRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CurrentPartySection.useCallback[loadRequests]": async ()=>{
            if (!user) {
                setRequests([]);
                setLoading(false);
                return;
            ...
            setLoading(true);
            setError(null);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$services$2f$partyMemberService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partyMemberService"].getPendingRequestsForHost();
            if (!result.success) {
                setRequests([]);
                var _result_error;
                setError((_result_error = result.error) !== null && _result_error !== void 0 ? _result_error : "Failed to load requests");
            } else {
                var _result_requests;
                const pending = (_result_requests = result.requests) !== null && _result_requests !== void 0 ? _result_requests : [];
                setRequests(pending);
                pushNotificationsForRequests(pending);
            }
            setLoading(false);
        }
    }["CurrentPartySection.useCallback[loadRequests]"], [
        user,
        pushNotificationsForRequests
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CurrentPartySection.useEffect": ()=>{
            loadRequests();
        }
    }["CurrentPartySection.useEffect"], [
        loadRequests
    ...
    const handleApprove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CurrentPartySection.useCallback[handleApprove]": async (request)=>{
            setBusyIds({
                "CurrentPartySection.useCallback[handleApprove]": (ids)=>[
                        ...ids,
                        request.id
                    ]
            }["CurrentPartySection.useCallback[handleApprove]"]);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$services$2f$partyMemberService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partyMemberService"].approveRequest(request.id, request.party_id, request.user_id);
            if (!result.success) {
                var _result_error;
                setError((_result_error = result.error) !== null && _result_error !== void 0 ? _result_error : "Failed to approve request");
            }
            await loadRequests();
            setBusyIds({
                "CurrentPartySection.useCallback[handleApprove]": (ids)=>ids.filter({
                        "CurrentPartySection.useCallback[handleApprove]": (id)=>id !== request.id
                    }["CurrentPartySection.useCallback[handleApprove]"])
            }["CurrentPartySection.useCallback[handleApprove]"]);
            if (result.success) {
                removeNotification("join-request:".concat(request.id));
            }
        }
    }["CurrentPartySection.useCallback[handleApprove]"], [
        loadRequests,
    ...
    const handleDecline = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CurrentPartySection.useCallback[handleDecline]": async (request)=>{
            setBusyIds({
                "CurrentPartySection.useCallback[handleDecline]": (ids)=>[
                        ...ids,
                        request.id
                    ]
            }["CurrentPartySection.useCallback[handleDecline]"]);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$services$2f$partyMemberService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partyMemberService"].declineRequest(request.id);
            if (!result.success) {
                var _result_error;
                setError((_result_error = result.error) !== null && _result_error !== void 0 ? _result_error : "Failed to decline request");
            }
            await loadRequests();
            setBusyIds({
                "CurrentPartySection.useCallback[handleDecline]": (ids)=>ids.filter({
                        "CurrentPartySection.useCallback[handleDecline]": (id)=>id !== request.id
                    }["CurrentPartySection.useCallback[handleDecline]"])
            }["CurrentPartySection.useCallback[handleDecline]"]);
            if (result.success) {
                removeNotification("join-request:".concat(request.id));
    ...
    const getInitials = (profile)=>{
        const base = (profile === null || profile === void 0 ? void 0 : profile.nickname) || (profile === null || profile === void 0 ? void 0 : profile.full_name) || "?";
        ...
        children: [
            ...
            error ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                ...
                children: requests.map((request)=>{
                    var _request_party, _request_party1;
                    const partyDescription = ((_request_party = request.party) === null || _request_party === void 0 ? void 0 : _request_party.drop_off) || "destination";
                    const meetup = ((_request_party1 = request.party) === null || _request_party1 === void 0 ? void 0 : _request_party1.meetup_point) || "Meetup TBD";
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$avatar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Avatar"], {
                                            ...
                                            children: (profile === null || profile === void 0 ? void 0 : profile.avatar_url) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$avatar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AvatarImage"], {
                                                ...
                                                alt: (profile === null || profile === void 0 ? void 0 : profile.nickname) || (profile === null || profile === void 0 ? void 0 : profile.full_name) || "Rider"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(main)/dashboard/components/CurrentPartySection.tsx",
                                                lineNumber: 153,
                                                columnNumber: 25
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: (profile === null || profile === void 0 ? void 0 : profile.nickname) || (profile === null || profile === void 0 ? void 0 : profile.full_name) || "Rider"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(main)/dashboard/components/CurrentPartySection.tsx",
                                                    lineNumber: 159,
                                                    columnNumber: 23
                                                }, this),
                                                (profile === null || profile === void 0 ? void 0 : profile.university) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-xs text-muted-foreground",
...
_s(CurrentPartySection, "sZXPXfNwhmZ5PpqNHiTiStQ+Zvs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$notificationsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationsStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$notificationsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationsStore"],
...
_c = CurrentPartySection;
var _c;
__turbopack_context__.k.register(_c, "CurrentPartySection");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$hooks$2f$useDashboard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/(main)/dashboard/hooks/useDashboard.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$components$2f$CurrentPartySection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/(main)/dashboard/components/CurrentPartySection.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function HomePage() {
    _s();
    const { welcomeName, isLoading, hasActiveParty } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$hooks$2f$useDashboard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboard"])();
    if (isLoading) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$components$2f$CurrentPartySection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                        fileName: "[project]/src/app/(main)/dashboard/page.tsx",
                        lineNumber: 27,
                        columnNumber: 9
                    }, this),
...
_s(HomePage, "+k7u1BgAKQ7viftsgYSGsoCb3eo=", false, function() {
    return [
...
//# sourceMappingURL=src_1f7fb7ef._.js.map