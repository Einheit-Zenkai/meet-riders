...
"[project]/src/app/(main)/hostparty/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$partyStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/partyStore.ts [app-client] (ecmascript)");
...
const LocationPicker = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(_c1 = ()=>__turbopack_context__.r("[project]/src/components/LocationPicker.tsx [app-client] (ecmascript, next/dynamic entry, async loader)")(__turbopack_context__.i), {
    loadableGenerated: {
        modules: [
...
function HostPartyPage() {
    ...
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(); // Get user from auth context
    ...
    const [isAlreadyHosting, setIsAlreadyHosting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const { addParty } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$partyStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    // Form state
    const [partySize, setPartySize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(2);
    ...
    // Map coordinates
    const [startCoords, setStartCoords] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [destCoords, setDestCoords] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [displayUniversity, setDisplayUniversity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [myUniversity, setMyUniversity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [durationMinutes, setDurationMinutes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(10);
    const [hostComments, setHostComments] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    // ✅ Check if user is already hosting
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HostPartyPage.useEffect": ()=>{
            const checkIfHosting = {
                "HostPartyPage.useEffect.checkIfHosting": async ()=>{
                    var _this;
                    ...
                    setMyUniversity((prof === null || prof === void 0 ? void 0 : prof.university) || "");
                    var _show_university;
                    // default display state to profile's preference if available
                    setDisplayUniversity((_show_university = (_this = prof) === null || _this === void 0 ? void 0 : _this.show_university) !== null && _show_university !== void 0 ? _show_university : false);
                }
            }["HostPartyPage.useEffect.checkIfHosting"];
            checkIfHosting();
        }
    }["HostPartyPage.useEffect"], [
        user,
    ...
    const handleRideToggle = (rideName)=>{
        if (selectedRides.includes(rideName)) {
            ...
            if (selectedRides.length < 2) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("You can only select a maximum of 2 ride options.");
            }
        }
    };
    const handleStartParty = async ()=>{
        if (!meetupPoint || !dropOff || partySize < 2) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please fill out the meetup point, drop-off, and set a party size of at least 2.");
            return;
        }
        if (!startCoords || !destCoords) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please select both a start and destination point on the map.");
            return;
        }
        if (!user) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("You must be logged in to host a party.");
            return;
        }
        const payload = {
            host_id: user.id,
        ...
        if (error) {
            ...
            if (typeof error.message === "string" && error.message.includes("active party")) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("You already have a live party. Let it expire or end it before creating another.");
                setIsAlreadyHosting(true);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || 'Failed to create party');
            }
        } else {
            var _DURATION_OPTIONS_find;
            var _DURATION_OPTIONS_find_label;
            // Also add to local context so it appears immediately
            const durationLabel = (_DURATION_OPTIONS_find_label = (_DURATION_OPTIONS_find = DURATION_OPTIONS.find((option)=>option.minutes === durationMinutes)) === null || _DURATION_OPTIONS_find === void 0 ? void 0 : _DURATION_OPTIONS_find.label) !== null && _DURATION_OPTIONS_find_label !== void 0 ? _DURATION_OPTIONS_find_label : "".concat(durationMinutes, " min");
            addParty({
                partySize,
                meetupPoint,
                dropOff,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Party created. Redirecting to Current Parties…");
            ...
            children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            ...
                                            children: [
                                                ...
                                                !myUniversity && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: rideOptions.map((ride)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>handleRideToggle(ride.name),
                                    className: "flex items-center space-x-2 px-4 py-2 rounded-full border-2 transition-colors ".concat(selectedRides.includes(ride.name) ? "bg-primary text-primary-foreground border-primary" : "bg-background text-foreground border-input hover:border-foreground/50"),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ride.icon, {
                                            className: "w-5 h-5"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(main)/hostparty/page.tsx",
                                            lineNumber: 345,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex flex-wrap gap-3",
                            children: DURATION_OPTIONS.map((param)=>{
                                let { minutes, label } = param;
...
_s(HostPartyPage, "pgfteCo/OeTjdJgV1wTphmVBj+Q=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$partyStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
_c3 = HostPartyPage;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "RideMap");
__turbopack_context__.k.register(_c1, "LocationPicker$dynamic");
__turbopack_context__.k.register(_c2, "LocationPicker");
__turbopack_context__.k.register(_c3, "HostPartyPage");
...
const CarTaxiFront = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("car-taxi-front", __iconNode);
;
...
//# sourceMappingURL=_4fac9fd1._.js.map