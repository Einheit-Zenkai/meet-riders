...
"[project]/src/app/(main)/current-party/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CurrentPartyPage() {
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "CurrentPartyPage.useAuthStore[user]": (state)=>state.user
    }["CurrentPartyPage.useAuthStore[user]"]);
    const authLoading = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "CurrentPartyPage.useAuthStore[authLoading]": (state)=>state.loading
    }["CurrentPartyPage.useAuthStore[authLoading]"]);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CurrentPartyPage.useMemo[supabase]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])()
    }["CurrentPartyPage.useMemo[supabase]"], []);
    const addNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$notificationsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationsStore"])({
        "CurrentPartyPage.useNotificationsStore[addNotification]": (s)=>s.add
    }["CurrentPartyPage.useNotificationsStore[addNotification]"]);
    const hasNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$notificationsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationsStore"])({
        "CurrentPartyPage.useNotificationsStore[hasNotification]": (s)=>s.has
    }["CurrentPartyPage.useNotificationsStore[hasNotification]"]);
    ...
    const selectedParty = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CurrentPartyPage.useMemo[selectedParty]": ()=>selectedId ? parties.find({
                "CurrentPartyPage.useMemo[selectedParty]": (p)=>p.id === selectedId
            }["CurrentPartyPage.useMemo[selectedParty]"]) || null : null
    }["CurrentPartyPage.useMemo[selectedParty]"], [
        parties,
        selectedId
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CurrentPartyPage.useEffect": ()=>{
            if (!authLoading && !user) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CurrentPartyPage.useEffect": ()=>{
            const load = {
                "CurrentPartyPage.useEffect.load": async ()=>{
                    if (!user) return;
                    setLoading(true);
                    try {
                        var _casted_;
                        ...
                        let joined = [];
                        const ids = (myMemberRows || []).map({
                            "CurrentPartyPage.useEffect.load.ids": (r)=>r.party_id
                        }["CurrentPartyPage.useEffect.load.ids"]);
                        if (ids.length) {
                        ...
                        const mergedRaw = [
                            ...
                            "CurrentPartyPage.useEffect.load.mergedRaw": (acc, p)=>acc.find({
                                    "CurrentPartyPage.useEffect.load.mergedRaw": (x)=>x.id === p.id
                                }["CurrentPartyPage.useEffect.load.mergedRaw"]) ? acc : acc.concat(p)
                        }["CurrentPartyPage.useEffect.load.mergedRaw"], []);
                        // map to Party shape (dates)
                        const casted = mergedRaw.map({
                            "CurrentPartyPage.useEffect.load.casted": (p)=>({
                                    ...p,
                        ...
                        }["CurrentPartyPage.useEffect.load.casted"]);
                        setParties(casted);
                        var _ref;
                        setSelectedId((_ref = (_casted_ = casted[0]) === null || _casted_ === void 0 ? void 0 : _casted_.id) !== null && _ref !== void 0 ? _ref : null);
                    } finally{
                        setLoading(false);
                    }
                }
            }["CurrentPartyPage.useEffect.load"];
            load();
        }
    }["CurrentPartyPage.useEffect"], [
        user,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CurrentPartyPage.useEffect": ()=>{
            const loadDetails = {
                "CurrentPartyPage.useEffect.loadDetails": async ()=>{
                    if (!selectedParty) return;
                    // Load members via service (RLS-safe) and compute excluding host
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$services$2f$partyMemberService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partyMemberService"].getPartyMembers(selectedParty.id);
                    ...
                    const nonHostCount = memberList.filter({
                        "CurrentPartyPage.useEffect.loadDetails": (m)=>m.user_id !== selectedParty.host_id
                    }["CurrentPartyPage.useEffect.loadDetails"]).length;
                    if (expired && nonHostCount > 0) {
                        const id = "live-start:".concat(selectedParty.id);
                        if (!hasNotification(id)) {
                            addNotification({
                                id,
                                message: "".concat((hostProfile === null || hostProfile === void 0 ? void 0 : hostProfile.nickname) || (hostProfile === null || hostProfile === void 0 ? void 0 : hostProfile.full_name) || 'Host', "'s party has started for ").concat(selectedParty.drop_off, ". Click to open."),
                                timestamp: new Date(),
                                read: false,
                                href: "/live-party?id=".concat(selectedParty.id)
                            });
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Party started! Check the notification bell.");
                        }
                    }
            ...
            }["CurrentPartyPage.useEffect.loadDetails"];
            loadDetails();
        }
    }["CurrentPartyPage.useEffect"], [
        selectedParty,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CurrentPartyPage.useEffect": ()=>{
            ...
            const timer = setTimeout({
                "CurrentPartyPage.useEffect.timer": async ()=>{
                    // Re-check members right at expiry time and exclude host explicitly
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$services$2f$partyMemberService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partyMemberService"].getPartyMembers(selectedParty.id);
                    const memberList = res.success && res.members ? res.members : [];
                    const nonHostCount = memberList.filter({
                        "CurrentPartyPage.useEffect.timer": (m)=>m.user_id !== selectedParty.host_id
                    }["CurrentPartyPage.useEffect.timer"]).length;
                    if (nonHostCount > 0) {
                        const id = "live-start:".concat(selectedParty.id);
                        if (!hasNotification(id)) {
                            addNotification({
            ...
            }["CurrentPartyPage.useEffect.timer"], Math.min(msUntilExpiry + 100, 2_147_483_647)); // slight buffer, clamp to max setTimeout
            return ({
                "CurrentPartyPage.useEffect": ()=>clearTimeout(timer)
            })["CurrentPartyPage.useEffect"];
        }
    }["CurrentPartyPage.useEffect"], [
        selectedParty,
    ...
    const handleLeave = async ()=>{
        ...
        setBusy(true);
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$services$2f$partyMemberService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partyMemberService"].leaveParty(selectedParty.id);
        if (!res.success) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res.error || 'Failed to leave');
        else {
    ...
    const handleCancel = async ()=>{
        ...
        if (error) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to cancel');
        else {
    ...
    const handleKick = async (member)=>{
        ...
        if (!isHost) return;
        const ok = confirm("Kick ".concat(((_member_profile = member.profile) === null || _member_profile === void 0 ? void 0 : _member_profile.nickname) || ((_member_profile1 = member.profile) === null || _member_profile1 === void 0 ? void 0 : _member_profile1.full_name) || 'this user', "?"));
        if (!ok) return;
        try {
            setBusy(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$main$292f$dashboard$2f$services$2f$partyMemberService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partyMemberService"].kickMember(selectedParty.id, member.user_id);
            if (!res.success) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res.error || 'Failed to kick');
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-muted-foreground",
                                children: "You aren’t in any party right now."
                            }, void 0, false, {
                                fileName: "[project]/src/app/(main)/current-party/page.tsx",
                                lineNumber: 270,
                                columnNumber: 13
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                className: "space-y-2",
                                children: [
                                    parties.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-muted-foreground",
                                        children: "You haven’t joined any parties yet."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(main)/current-party/page.tsx",
                                        lineNumber: 295,
                                        columnNumber: 15
                                    }, this),
                                    parties.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            onClick: ()=>setSelectedId(p.id),
                                            className: "w-full text-left p-3 rounded border transition ".concat(selectedId === p.id ? 'bg-accent border-accent-foreground/20' : 'bg-background border-input hover:border-foreground/30'),
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex items-center justify-between",
                                                    children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                            size: "sm",
                                                            variant: "secondary",
                                                            onClick: ()=>router.push("/live-party?id=".concat(selectedParty.id)),
                                        ...
                                        selectedParty.host_comments && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        members.map((m)=>{
                                                            var _m_profile, _m_profile1, _m_profile2, _m_profile3, _m_profile4, _m_profile5, _m_profile6;
                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CurrentPartyPage, "qYu0vwPKLumlBnKmyhpYWF61HF4=", false, function() {
    return [
...
_c = CurrentPartyPage;
var _c;
__turbopack_context__.k.register(_c, "CurrentPartyPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_b5b10801._.js.map