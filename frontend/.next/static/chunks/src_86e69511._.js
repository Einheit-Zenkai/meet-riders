    ...
    const handleJoinParty = async ()=>{
        ...
        try {
            ...
            if (result.success) {
                ...
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('party_requests').insert([
                    {
                        party_id: party.id,
                        user_id: user.id,
                        status: 'Pending'
                ...
                if (error) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to send party request');
                } else {
...
//# sourceMappingURL=src_86e69511._.js.map