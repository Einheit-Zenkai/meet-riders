...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set)=>({
        ...
        init: ()=>{
            ...
            // Get initial session
            supabase.auth.getUser().then((param)=>{
                let { data: { user } } = param;
                set({
                    user,
                    loading: false
            ...
            const { data: { subscription } } = supabase.auth.onAuthStateChange((event, session)=>{
                var _session_user;
                set({
                    user: (_session_user = session === null || session === void 0 ? void 0 : session.user) !== null && _session_user !== void 0 ? _session_user : null,
                    loading: false
                });
            });
...
"[project]/src/stores/partyStore.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const usePartyStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set)=>({
        parties: [],
        addParty: (partyData)=>{
...
"[project]/src/components/store-initializer.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function StoreInitializer() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StoreInitializer.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getState().init();
            const cleanupParties = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$partyStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getState().startCleanup();
            return ({
                "StoreInitializer.useEffect": ()=>{
                    cleanupParties();
                }
...
//# sourceMappingURL=src_7bd07100._.js.map