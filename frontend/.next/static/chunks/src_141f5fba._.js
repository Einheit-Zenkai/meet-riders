                ...
                "CurrentPartyPage.useEffect.load": async ()=>{
                    ...
                    try {
                        ...
                        const merged = [
                            ...
                            "CurrentPartyPage.useEffect.load.merged": (acc, p)=>acc.find({
                                    "CurrentPartyPage.useEffect.load.merged": (x)=>x.id === p.id
                                }["CurrentPartyPage.useEffect.load.merged"]) ? acc : acc.concat(p)
                        }["CurrentPartyPage.useEffect.load.merged"], []);
                        // map to Party shape (dates)
                        const casted = merged.map({
...
//# sourceMappingURL=src_141f5fba._.js.map