...
"[project]/src/app/(Authentication)/user-create/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function UserCreatePage() {
    ...
    const handleCreateProfile = async ()=>{
        ...
        let avatar_url = null;
        if (imageFile) {
            const fileName = "".concat(user.id, "-").concat(Date.now());
...
_s(UserCreatePage, "nJWy8++YBR5ymIRcur0xmefjntY=", false, function() {
    return [
...
_c = UserCreatePage;
var _c;
__turbopack_context__.k.register(_c, "UserCreatePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_cd658bf3._.js.map